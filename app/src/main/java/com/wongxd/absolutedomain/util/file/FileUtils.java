...
public class FileUtils {
     ...
     * 默认的根目录
     */
    public static final String DEFAULT_ROOT_PATH = "/mnt/绝对领域/";

    /**
     * 默认的缩略图目录
     */
    public static final String DEFAULT_SCREENSHOT_PATH = "/mnt/绝对领域/screenshot/";
    ...
    public static String getRootDirPath() {
        ...
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            path = Environment.getExternalStorageDirectory() + "/绝对领域/";
        }
        return path;
    }
